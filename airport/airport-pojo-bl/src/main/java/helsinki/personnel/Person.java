...
public class Person extends ActivatableAbstractEntity<DynamicEntityKey> {
    ...
    @MapTo
    @Required
    @Title(value = "First name", desc = "Respersents person's first name")
    private String name;

    @IsProperty
    @MapTo
    @Required
    @Title(value = "Surname", desc = "Respersents person's second name")
    ...
    @Readonly
    @Calculated
    @Title(value = "Full name", desc = "Represents persons full name")
    private String desc;
